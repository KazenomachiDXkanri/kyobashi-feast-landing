...
const Footer = () => {
  return <footer className="border-t border-border bg-kaze-black pb-24 pt-16 md:pb-16">
      <div className="container px-4">
        ...
        <div className="text-center">
          <p className="text-xs tracking-wider text-white/30">© 2026 風の街 京橋店. All rights reserved.</p>
        </div>
      </div>
    </footer>;
};
